        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-primary-foreground/80 max-w-2xl mx-auto">
              Be the first responder in your community. Get trained, certified, and 
              help save lives during medical emergencies.
            </p>
            ...
            {[
              {
                icon: "🎓",
                title: "Free Training",
                description: "Get certified in CPR, first aid, and emergency response",
              },
              {
                icon: "🏆",
                title: "Recognition",
                description: "Earn badges and be recognized in your community",
              },
              {
                icon: "💰",
                title: "Incentives",
                description: "Receive rewards for successful emergency responses",
              },
              {
                icon: "❤️",
                title: "Save Lives",
                description: "Make a real difference when every second counts",
              },
            ].map((benefit) => (
              <motion.div
                key={benefit.title}
      ...
      <footer className="bg-primary text-primary-foreground py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-primary-foreground/70">
            © 2024 Sanjeevani. Saving lives, one response at a time.
          </p>
        </div>
      </footer>
    </div>
